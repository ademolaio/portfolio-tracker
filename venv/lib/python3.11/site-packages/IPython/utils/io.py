...
def raw_print(*args, **kw):
    ...
    warn("IPython.helper.io.raw_print has been deprecated since IPython 7.0", DeprecationWarning, stacklevel=2)
...
def raw_print_err(*args, **kw):
    ...
    warn("IPython.helper.io.raw_print_err has been deprecated since IPython 7.0", DeprecationWarning, stacklevel=2)
